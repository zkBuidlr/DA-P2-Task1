...
const About = () => {
  return (
    <section id="about" class="mt-10 mb-32 text-gray-800 text-center">
      <h2 class="text-3xl font-bold mb-12 text-center">About</h2>
            ...
            >
              ...
              <a href="#!">
                <div
                  ...
                  styles="background-color: rgba(251, 251, 251, 0.2)"
                ></div>
              </a>
            </div>
